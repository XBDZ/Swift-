...
public enum HB_AlignType {
    ...
    fileprivate func layoutAttributes(isInner: Bool, isVertical: Bool) -> HB_LayoutAttributes {
        let attributes = HB_LayoutAttributes()
        ...
        switch self {
            ...
            // 仅内部参照需要
            case .Center:
                return HB_LayoutAttributes(horizontal: .centerX, referHorizontal: .centerX, vertical: .centerY, referVertical: .centerY)
        }
    }
}
...
extension UIView {
    ...
    :returns: 约束数组
    */
  @discardableResult  public func HB_Fill(referView: UIView, insets: UIEdgeInsets = UIEdgeInsets.zero) -> [NSLayoutConstraint] {
   ...
   @discardableResult  public func HB_AlignInner(type: HB_AlignType, referView: UIView, size: CGSize?, offset: CGPoint = CGPoint.zero) -> [NSLayoutConstraint]  {
        
        return HB_AlignLayout(referView: referView, attributes: type.layoutAttributes(isInner: true, isVertical: true), size: size, offset: offset)
    }
    ...
    :returns: 约束数组
    */
   @discardableResult public func HB_AlignVertical(type: HB_AlignType, referView: UIView, size: CGSize?, offset: CGPoint = CGPoint.zero) -> [NSLayoutConstraint] {
        
        return HB_AlignLayout(referView: referView, attributes: type.layoutAttributes(isInner: false, isVertical: true), size: size, offset: offset)
    }
    ...
    :returns: 约束数组
    */
   @discardableResult public func HB_AlignHorizontal(type: HB_AlignType, referView: UIView, size: CGSize?, offset: CGPoint = CGPoint.zero) -> [NSLayoutConstraint] {
    ...
    :returns: 约束数组
    */
   @discardableResult public func HB_HorizontalTile(views: [UIView], insets: UIEdgeInsets) -> [NSLayoutConstraint] {
        ...
        firstView.HB_AlignInner(type: HB_AlignType.TopLeft, referView: self, size: nil, offset: CGPoint(x: insets.left, y: insets.top))
    ...
    :returns: 约束数组
    */
   @discardableResult public func HB_VerticalTile(views: [UIView], insets: UIEdgeInsets) -> [NSLayoutConstraint] {
        ...
        for i in 1..<views.count {
            let subView = views[i]
            cons += subView.HB_sizeConstraints(referView: firstView)
            subView.HB_AlignVertical(type: HB_AlignType.BottomLeft, referView: preView, size: nil, offset: CGPoint(x: 0, y: insets.bottom))
            preView = subView
        }
    ...
    :returns: 对应的约束
    */
   @discardableResult public func HB_Constraint(constraintsList: [NSLayoutConstraint], attribute: NSLayoutAttribute) -> NSLayoutConstraint? {
    ...
    :returns: 约束数组
    */
  @discardableResult fileprivate  func HB_AlignLayout(referView: UIView, attributes: HB_LayoutAttributes, size: CGSize?, offset: CGPoint) -> [NSLayoutConstraint] {
        
        translatesAutoresizingMaskIntoConstraints = false
        
        var cons = [NSLayoutConstraint]()
        
        cons += HB_positionConstraints(referView: referView, attributes: attributes, offset: offset)
        
        if size != nil {
            cons += HB_sizeConstraints(size: size!)
        }
    ...
    :returns: 约束数组
    */
  @discardableResult fileprivate  func HB_sizeConstraints(size: CGSize) -> [NSLayoutConstraint] {
    ...
    :returns: 约束数组
    */
  @discardableResult fileprivate  func HB_sizeConstraints(referView: UIView) -> [NSLayoutConstraint] {
    ...
    :returns: 约束数组
    */
  @discardableResult fileprivate  func HB_positionConstraints(referView: UIView, attributes: HB_LayoutAttributes, offset: CGPoint) -> [NSLayoutConstraint] {
...
///  布局属性
private final class HB_LayoutAttributes {
